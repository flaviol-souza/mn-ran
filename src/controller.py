...
class UcvController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # ---- Carrega policy.yaml ----
        policy_file = os.environ.get("UCV_POLICY", "policies/policy.yaml")
        print(policy_file)
        ...
        self.kpi_export = _resolve_out(self.run_dir, None,
                               "controller_c2_kpi.jsonl")

        self.video_export = _resolve_out(self.run_dir, None,
        ...
        self.video_if      = self.policy.get("iface_video", "uav-eth0")
